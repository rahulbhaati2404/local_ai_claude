...
class Settings(BaseSettings):
    ...
    # Code Editor Agent Controls
    CODE_EDITOR_AGENT_MAX_ITERATIONS: int = 12
    CODE_EDITOR_AGENT_FORCE_COMPLETE_AFTER: int = 9
    CODE_EDITOR_AGENT_MAX_HISTORY_ENTRIES: int = 6
    CODE_EDITOR_AGENT_MAX_TOOL_RESULTS: int = 6
    CODE_EDITOR_AGENT_REPEAT_THRESHOLD: int = 3
    CODE_EDITOR_AGENT_MAX_TOOL_CALLS_PER_ITERATION: int = 6
